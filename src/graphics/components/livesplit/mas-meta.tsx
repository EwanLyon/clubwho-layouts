...
const MaSMetaContainer = styled.div`
	width: 100%;
	color: #000000;
`;
...
export const MaSMeta: React.FC<Props> = (_props: Props) => {
	const [metaRep] = useReplicant<RunMetadata, RunMetadata>('livesplit:runMetadata', {});
