	...
	render() {
		return (
			<ThemeProvider theme={dashboardTheme}>
				<TextField label="Seconds" value={this.state.text} onChange={this.textChange} variant="filled" />
				<TextField label="Seconds" value={this.state.time} onChange={this.timeChange} variant="filled" />
